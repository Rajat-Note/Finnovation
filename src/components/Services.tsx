...
export const Services = () => {
    ...
    return ( 
        <div className="min-h-screen h-screen w-full bg-[#f5f8fc] flex flex-col justify-center items-center gap-8">
            <h1 className="font-bold text-4xl"><span className="text-[#8ec21e]">Services</span> We Offer</h1>
            <p className="w-[35%] text-center text-gray-500 font-semibold">We strive to offer solutions that are not only innovative but also sustainable and reliable, enhancing the overall financial well-being of our clients.</p>
